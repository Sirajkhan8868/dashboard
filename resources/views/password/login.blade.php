...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    ...
    <meta property="twitter:account_id" content="786331568" />
	  	  <meta property="og:url" content="https://bootsnipp.com/snippets/GaZG0" />
    <meta itemprop="name" content="Bootstrap Login Form Example">
    <meta itemprop="description" content="Bootstrap example of Login Form using HTML, Javascript, jQuery, and CSS. Snippet by mishajib">
    <meta name="description" content="Bootstrap example of Login Form using HTML, Javascript, jQuery, and CSS. Snippet by mishajib">
    <meta name="keywords" content="Bootstrap, css, javascript, jquery, code, example, snippet,Login Form, login, ">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@bootsnipp">
    <meta name="twitter:title" content="Login Form">
    <meta name="twitter:description" content="High quality Bootstrap 4.1.1 Snippet by mishajib. Share yours today!">
    <meta name="twitter:creator" content="@bootsnipp">
    <meta name="twitter:image" content="https://d2d3qesrx8xj6s.cloudfront.net/img/screenshots/nofeat-ac96e6dac5604a8591f818ec7f727ccad0d132bb.jpg ">
      <meta property="og:image" content="https://bootsnipp.com/img/logo.jpg" />
    <meta property="og:site_name" content="Bootsnipp.com" />

      <meta property="og:description" content="Awesome Bootstrap HTML CSS JS Snippet on Bootsnipp.com." />
      <title>Bootstrap Snippet Login Form using HTML CSS  Bootstrap  </title>
...
<script>
  ...
  ga('send', 'pageview');
        ...
        setTimeout(function() {
          ...
          var promos = document.querySelectorAll(".btl6nh");
	  var isblock = 0;
...
-->
	 ...
	 <div class="col-sm-12 col-md-4">
                <div class="title-bar" style="margin-bottom:0px;">
                    <a href="https://bootsnipp.com/mishajib" title="Bootstrap snippets by mishajib" class="avatar-sm-container pull-left"><img src="https://bootsnipp.com/img/avatars/e128b73aaecbd59e7e57a1586259ae6664002b06.jpg" class="img-rounded user-avatar-sm"></a>

                    <h4 itemprop="name">&quot;Login Form&quot;<br>
                    <small>Bootstrap 4.1.1 Snippet by <a href="https://bootsnipp.com/mishajib" title="Bootstrap snippets by mishajib" itemscope itemtype="http://schema.org/Person" itemprop="name">mishajib</a></small>
                    </h4>
...
-->
	...
	<div class="row" style="margin-top: 10px;margin-bottom:10px;">
                   <div class="col-md-8">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" role="menu">
                                                        <li><a href="https://bootsnipp.com/fullscreen/GaZG0" target="_blank"><span class="glyphicon glyphicon-fullscreen"></span> View Full Screen</a></li>
                                                      </ul>
                        </div>
                        <div class="btn-group">
                          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
				...
				<li><a href="https://bootsnipp.com/fork/GaZG0" id="reboot" title="Copy this snippet"><span class="icon-code-fork"></span> Fork this</a></li>

			  </ul>
			</div>
<!--                        <a href="https://bootsnipp.com/fork/GaZG0" id="reboot" class="btn btn-default tip" title="Copy this snippet"><span class="glyphicon glyphicon-retweet"></span> Fork this</a>-->
			<div id="action-bar" style="display: inline-block">
			    <a href="#" class="btn btn-default disabled"><i class="icon-eye-open"></i> 169.9K</a>
			    <a href="#comments" class="btn btn-default tip" title="View comments"><i class="icon-comment"></i>&nbsp</a>
			    				<a href="https://bootsnipp.com/favorites/snippet/GaZG0?url=snippets%2FGaZG0" class="btn btn-default tip" title="Please log in to favorite this snippet"><span class="glyphicon glyphicon-thumbs-up"></span> 18 Fav</a>
			    			</div>
                    </div>
		    <div class="col-md-4">
				...
				<a href="#" class="btn btn-primary"
				  onclick="window.open(
				      'https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://bootsnipp.com/snippets/GaZG0') +'&t=' + encodeURIComponent('Login Form #Bootstrap #snippet'),
				...
				<a href="#" class="btn btn-info"
				  onclick="window.open(
				      'https://twitter.com/share?url='+encodeURIComponent('http://bootsnipp.com/snippets/GaZG0')+'&text='+encodeURIComponent('I shared a cool #snippet on @bootsnipp  :') + '&count=none/',
    ...
    <div id="playground-container" style="overflow: hidden">
        <div id="preview-container"><iframe id="snippet-preview" class="preview-iframe" src="//s.bootsnipp.com/iframe/GaZG0"></iframe></div>
        <div class="container">
...
&lt;/body&gt;
&lt;/html&gt;</div>
                    <div id="editor-css" class="playground-editor" style="height:500px;" itemprop="sampleType">@import url(https://fonts.googleapis.com/css?family=Raleway:300,400,600);
...
.login-form .row
{
    ...
    <div class="container">
		<div class="col-md-12">
                        <h2>Related: <small><a href="https://bootsnipp.com/similar/GaZG0">See <!---3--> More</a></small></h2>
        <div class="row">
          <div class="scrollpost col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
    <div class="thumbnail bootsnipp-thumb">
	    <div>
	    	<p class="pull-right view-counts">
	    		<a target="_new" href="https://www.creative-tim.com/product/awesome-landing-page?partner=114912" class="tip" data-toggle="tooltip" title="Favorited"></a>
<a href="/templates">
<span class="label label-info tip" data-toggle="tooltip" title="" data-original-title="Templates">
Free
Template</span></a>
	    	</p>
	    	<p class="lead snipp-title">
	    		<a target="_new" href="https://www.creative-tim.com/product/awesome-landing-page?partner=114912">Awesome Landing Page<br/></a>
	    	</p>
	    </div>
            <a target="_new" href="https://www.creative-tim.com/product/awesome-landing-page?partner=114912">
    ...
    <div class="thumbnail bootsnipp-thumb">
	    <div>
	    	<p class="pull-right view-counts hidden-md">
	    		<a href="https://bootsnipp.com/snippets/bxzmb" class="tip" data-toggle="tooltip" title="Viewed">456.7K <i class="icon-eye-open"></i></a>

	    		<a href="https://bootsnipp.com/snippets/bxzmb" class="tip" data-toggle="tooltip" title="Favorited">44 <i class="icon-thumbs-up"></i></a>
<!--	    		<a href="https://bootsnipp.com/tags/4.1.1"><span class="label label-info tip" data-toggle="tooltip" title="Bootstrap version">4.1.1</span></a>-->
	    	...
	    	<p class="lead snipp-title">
	    		<a href="https://bootsnipp.com/snippets/bxzmb">login-form</a>
	    	</p>
	    </div>
            <a href="https://bootsnipp.com/snippets/bxzmb">
                <img class="lazy" data-original="//d2d3qesrx8xj6s.cloudfront.net/img/screenshots/nofeat-d3c091c068b6e1fc13464df28bc8d8d18b187e61.jpg" width="320" height="240" alt="login-form">
        </a>
    ...
    <div class="thumbnail bootsnipp-thumb">
	    <div>
	    	<p class="pull-right view-counts hidden-md">
	    		<a href="https://bootsnipp.com/snippets/aMZ5o" class="tip" data-toggle="tooltip" title="Viewed">119.9K <i class="icon-eye-open"></i></a>

	    		<a href="https://bootsnipp.com/snippets/aMZ5o" class="tip" data-toggle="tooltip" title="Favorited">31 <i class="icon-thumbs-up"></i></a>
<!--	    		<a href="https://bootsnipp.com/tags/4.1.1"><span class="label label-info tip" data-toggle="tooltip" title="Bootstrap version">4.1.1</span></a>-->
	    	</p>
	    	<p class="lead snipp-title">
	    		<a href="https://bootsnipp.com/snippets/aMZ5o">Bootstrap Two Login Form</a>
	    	</p>
	    </div>
            <a href="https://bootsnipp.com/snippets/aMZ5o">
                <img class="lazy" data-original="//d2d3qesrx8xj6s.cloudfront.net/img/screenshots/nofeat-e964f3e6e1aaf64526436edbe9c39243a8a8b81d.jpg" width="320" height="240" alt="Bootstrap Two Login Form">
        </a>
    ...
    <div class="thumbnail bootsnipp-thumb">
	    <div>
	    	<p class="pull-right view-counts hidden-md">
	    		<a href="https://bootsnipp.com/snippets/z8aQr" class="tip" data-toggle="tooltip" title="Viewed">188.9K <i class="icon-eye-open"></i></a>

	    		<a href="https://bootsnipp.com/snippets/z8aQr" class="tip" data-toggle="tooltip" title="Favorited">37 <i class="icon-thumbs-up"></i></a>
<!--	    		<a href="https://bootsnipp.com/tags/4.1.1"><span class="label label-info tip" data-toggle="tooltip" title="Bootstrap version">4.1.1</span></a>-->
	    	</p>
	    	<p class="lead snipp-title">
	    		<a href="https://bootsnipp.com/snippets/z8aQr">Boostrap Dual Login Form</a>
	    	</p>
	    </div>
            <a href="https://bootsnipp.com/snippets/z8aQr">
                <img class="lazy" data-original="//d2d3qesrx8xj6s.cloudfront.net/img/screenshots/nofeat-fe7cef0c2f03af4c1a0a9b4173f2dcad9b5da48d.jpg" width="320" height="240" alt="Boostrap Dual Login Form">
        </a>
...
<hr>
    <div class="container">
		<div class="col-md-8">
				...
				<input type="hidden" id="forumIdHash" value="GaZG0">
				<link rel="stylesheet"
      href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/styles/default.min.css">
<script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/highlight.min.js"></script>
<script>hljs.initHighlightingOnLoad();</script>
<style>.hljs { white-space: nowrap; max-height: 300px;}pre {padding:0}.forumDivOuter {padding:10px 10px;}.forumTagline {padding:10px 0;}.forumvote:hover {color:orange; cursor: pointer;}.forumText { font-weight:500; font-size:1.2em;}.forumName { font-weight:200; font-size:1em;}.forumTime { font-size:1em;}.forumKey { border-radius: 4px;    border: 2px solid #555;    width: 20px;    display: inline-flex;    align-items: center;    justify-content: center;    height: 20px; margin: 0 2px;}</style><div class="newPost"><div id="newPostContainer" class="container-fluid" style="margin-top:10px;"><!--<div class="row"><div class="col-xs-4"><hr style="margin-top:16px;border-top:1px solid #ccc;"></div><div class="col-xs-4 text-center"><a class="btn btn-md btn-warning" id="newPostButton">NEW POST</a></div><div class="col-xs-4"><hr style="margin-top:16px;border-top:1px solid #ccc;"></div></div>--></div><div class='forumDivOuter' style=''><div id="forumDiv"><textarea class="autoExpand forumPost form-control" rows="4" data-min-rows="4" placeholder="Enter your message here"></textarea><br/><button class="forumPostButton btn btn-default">Post</button><span style="margin: 0 10px;" class="pull-right"><a href="#" data-toggle="popover" title="" data-html="true" data-content="<ul><li>When asking a question, provide as much detail as possible.  Posts of simply &quot;It doesn't work&quot; may be removed.  </li><li>Don't Spam</li><li>Be respectful</li></ul>">Posting Guidelines</a></span><span style="margin: 0 10px;" class="pull-right"><a href="#" data-toggle="popover" title="" data-html="true" data-content="<ul><li><span class='forumKey'>`</span> - Surround code with backticks</li><li><span class='forumKey'>*</span> - Surround text with stars to italicize.</li><li><span class='forumKey'>&gt;</span><span class='forumKey'>&gt;</span> - A line starting with two greater than characters will be indented as a quote.</li><li>A blank line will separate paragraphs.</li></ul>">Formatting</a></span></div></div><hr><div class='col-md-12 hidden'><p class='forumTagline'><strong class='reply 0 name'></strong> - Now</p><hr></div></div><div id='jump33247' data-postid='33247' class='col-md-12 col-md-offset-0'><div class='forumText forumMax'><p>This is Great, well designed. I suggest a website that we can get more knowledge about web developing, It helped me to success my  various projects. https://w3schoolweb.com/</p><p>Use this link to access.</p></div><p class='forumTagline'><span class='forumName'>Samith94 <small>()</small></span> - <span class='text-muted'>2 years ago</span> - <a href='#' class='forumReply' data-id='33247'>Reply</a><span class='pull-right'><span data-vote='1' class='forumvote fa fa-chevron-up icon-chevron-up'></span> <span class='forumVoteTotal'>0</span> <span data-vote='-1' class='forumvote fa fa-chevron-down icon-chevron-down'></span></span></p><hr></div><div class='col-md-13 col-md-offset-1 hidden'><p class='forumTagline'><strong class='reply 33247 name'></strong> - Now</p><hr></div><div id='jump33246' data-postid='33246' class='col-md-12 col-md-offset-0'><div class='forumText forumMax'><p>This is Great, well designed. I suggest a website that we can get more knowledge about web developing, It helped me to success my  various projects. https://w3schoolweb.com/</p><p>Use this link to access.</p></div><p class='forumTagline'><span class='forumName'>Samith94 <small>()</small></span> - <span class='text-muted'>2 years ago</span> - <a href='#' class='forumReply' data-id='33246'>Reply</a><span class='pull-right'><span data-vote='1' class='forumvote fa fa-chevron-up icon-chevron-up'></span> <span class='forumVoteTotal'>0</span> <span data-vote='-1' class='forumvote fa fa-chevron-down icon-chevron-down'></span></span></p><hr></div><div class='col-md-13 col-md-offset-1 hidden'><p class='forumTagline'><strong class='reply 33246 name'></strong> - Now</p><hr></div>
