                      ...
                      <div class="card-body">
                        <table id="productsTable" class="table table-hover table-product" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="{{asset('assets/auth/images/products/products-xs-11.jpg')}}" alt="Product Image">
                              </td>
                              <td>Smart Watch</td>
                              <td>24551</td>
                              <td>19</td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="{{asset('assets/auth/images/products/products-xs-12.jpg')}}" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="{{asset('assets/auth/images/products/products-xs-13.jpg')}}" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="{{asset('assets/auth/images/products/products-xs-14.jpg')}}" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="{{asset('assets/auth/images/products/products-xs-15.jpg')}}" alt="Product Image">
                              </td>
                              <td>Headphones</td>
                              <td>24555</td>
                              <td>17</td>
                      ...
                      <div class="card card-default chat">
                        ...
                        <div class="card-body pb-0" data-simplebar style="height: 363px;">
                          ...
                          <div class="media media-chat">
                            <img src="{{asset('assets/auth/images/user/user-sm-01.jpg')}}" class="rounded-circle" alt="Avata Image">
                            <div class="media-body">
                          ...
                          <div class="media media-chat media-chat-right">
                            ...
                            <img src="{{asset('assets/auth/images/user/user-sm-02.jpg')}}" class="rounded-circle" alt="Avata Image">
                          </div>
